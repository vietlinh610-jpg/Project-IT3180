...
const getThongTinChuHo = async (req, res) => {
    ...
    try {
        ...
        const checkHK = await pool.request()
            .input('MaHoKhau', sql.VarChar, maHoKhau)
        ...
        if (result.recordset.length === 0) {
            return res.status(400).json({ message: "Hộ khẩu này chưa khai báo Chủ hộ!" });
        }

        // 3. Trả về tên và CCCD để Frontend tự điền
...
module.exports = { getListHoKhau, createHoKhau, updateHoKhau, deleteHoKhau, getThongTinChuHo };